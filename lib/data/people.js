...
import photoTim from '../../assets/images/about/tim.jpg'
...
import photoEleanort from '../../assets/images/about/eleanort.jpg'
import photoJason from '../../assets/images/about/jason.jpg'
import photoChloe from '../../assets/images/about/chloe.jpg'
import photoPaul from '../../assets/images/about/paul.jpg'
import photoJames from '../../assets/images/about/james.jpg'
...
export const team = [
  ...
  {
    photo: photoEleanort,
    name: "Eleanor Toulmin",
    bio: "Hello, I’m Eleanor. I enjoy spreadsheets and business processes. If I’m not playing with vlookups and pivot tables then I’m probably bouldering, cooking or watching cat videos on YouTube.",
    colour: "rgb(100,141,75)"
  },
  {
    photo: photoJason,
    name: "Jason Jacob",
    bio: "Hi, I'm Jason. I’m all about code, dev tooling and the buzzing of happy users. When I’m not picking apart cool tech, I’m in the garden with my dribbling french mastiff, drinking coffee, or trying to convince my kids I’m still cool.",
    links: [
      { name: "GitHub", url: "https://github.com/jayco" }
    ],
    colour: "rgb(103,132,216)"
  },
  {
    photo: photoChloe,
    name: "Chloe Hutchison",
    bio: "Hey, I’m Chloe! I love challenging myself to solve all sorts of tech problems. When I’m not engineering, I’m finding and mixing fun tunes to DJ with at parties.",
    links: [
      { name: "GitHub", url: "https://github.com/chloeruka" },
      { name: "Twitter", url: "https://twitter.com/rukacollie" }
    ],
    colour: "rgb(152,162,255)"
  },
  {
    photo: photoPaul,
    name: "Paul Annesley",
    bio: "Howdy, I’m Paul. I love tasteful software engineering and simple reliable systems. Also: bouldering, motorbikes, electronics, travel. Above all: my wife and child.",
    links: [
      { name: "GitHub", url: "https://github.com/pda" },
      { name: "Twitter", url: "https://twitter.com/pda" }
    ],
    colour: "rgb(174,225,205)"
  },
  {
    photo: photoJames,
    name: "James Healy",
    bio: "Hi, I’m James. I like using boring technology with predictable behaviour to solve real world problems. Life outside work is a less predictable mix of family, books, running and riding.",
    links: [
      { name: "GitHub", url: "https://github.com/yob" },
      { name: "Twitter", url: "https://twitter.com/jim_healy" },
      { name: "Site", url: "https://yob.id.au" }
    ],
