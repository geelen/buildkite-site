  ...
  .then(() => {
    ...
    server.use(function(req, res, next) {
      ...
      if (!dev) {
        ...
        res.header('Content-Security-Policy', "default-src 'self'; script-src 'self' https://analytics.buildkite.com/; style-src 'self' 'unsafe-inline'; img-src 'self' data: https://analytics.buildkite.com/ https://avatars0.githubusercontent.com https://avatars1.githubusercontent.com https://avatars2.githubusercontent.com https://avatars3.githubusercontent.com; media-src 'self' https://d3lj8s78qytm30.cloudfront.net; object-src 'none'")
