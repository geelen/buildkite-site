...
app.prepare()
  .then(() => {
    ...
    server.use(function(req, res, next) {
      ...
      res.header('Content-Security-Policy', "default-src 'self' 'unsafe-inline'; script-src 'self' 'unsafe-inline' https://www.google-analytics.com; media-src 'self' https://d3lj8s78qytm30.cloudfront.net")
